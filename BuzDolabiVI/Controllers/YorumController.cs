...
namespace BuzDolabiVI.Controllers
{
    public class YorumController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("yorumID,userID,tarifID,tarih,icerik")] Yorum yorum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("yorumID,userID,tarifID,tarih,icerik")] Yorum yorum)
        {
            if (id != yorum.yorumID)
            {
                return NotFound();
        ...
        private bool YorumExists(string id)
        {
